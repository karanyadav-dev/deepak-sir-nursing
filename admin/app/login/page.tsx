        ...
        <form onSubmit={handleLogin}>
          <div className="mb-4">
            ...
            <input
              ...
              placeholder="admin@deepaksir.com"
              required
            />
          </div>
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full bg-blue-600 text-white font-bold py-2 px-4 rounded-md hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed"
          >
